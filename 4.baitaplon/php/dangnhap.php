...
<div class="dangnhap">
  <div class="form-group text-tk">
    ...
    <input type="email" class="form-control" name="txtemail" id="txtemail1">
  </div>
  <div class="form-group text-mk">
    <label for="pwd">nhâp mật khẩu</label>
    <input type="password" class="form-control" name="txtmatkhau" id="txtmakhau1">
  </div>
  <button type="submit" class="btn btn-default bt-dn" id ="btdangnhap">đăng nhập</button>
